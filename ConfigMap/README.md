...
A [timoni.sh](http://timoni.sh) module for deploying ConfigMap to Kubernetes clusters.
...
```shell
timoni -n default apply ConfigMap oci://<container-registry-url>
```
...
```shell
timoni -n default delete ConfigMap
```
